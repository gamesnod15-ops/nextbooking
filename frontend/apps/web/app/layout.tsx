...
#preload-screen.hide { opacity: 0; visibility: hidden; }
    ...
    <html lang="tr" className={inter.variable}>
      ...
      <body className="antialiased">
        <div id="preload-screen">
          <div className="preload-inner">
            <div className="ps-lines">
              <div className="ps-line ps-l1"></div>
              <div className="ps-line ps-l2"></div>
              <div className="ps-line ps-l3"></div>
              <div className="ps-line ps-l4"></div>
              <div className="ps-line ps-l5"></div>
            </div>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          setTimeout(function() {
            var el = document.getElementById('preload-screen');
            if (el) { el.classList.add('hide'); setTimeout(function() { el.remove(); }, 600); }
          }, 3000);
        `}} />
      </body>
    </html>
