...
const stats = [
  { value: '10M+', label: 'Aylýk Gösterim' },
  { value: '%240', label: 'Ortalama ROI' },
  { value: '50K+', label: 'Týklanma/Ay' },
  { value: '%98', label: 'Müþteri Memnuniyeti' },
]

const benefits = [
  {
    icon: Eye, title: 'Dev Görünürlük', desc: 'Ana sayfa, kategori sayfalarý ve arama sonuçlarýnda iþletmeniz en önde yer alsýn.',
    gradient: 'from-amber-500 to-orange-500',
  },
  {
    icon: Target, title: 'Hedefli Eriþim', desc: 'Konum, kategori ve kullanýcý davranýþýna göre reklamlarýnýzý optimize edin.',
    gradient: 'from-blue-500 to-cyan-500',
  },
  {
    icon: TrendingUp, title: 'Gerçek Zamanlý ROI', desc: 'Her kampanyanýn gösterim, týklanma ve dönüþüm verilerini anlýk izleyin.',
    gradient: 'from-emerald-500 to-green-500',
  },
  {
    icon: BarChart3, title: 'Detaylý Analitik', desc: 'Rakip analizi, pazar trendleri ve performans raporlarý ile veri odaklý kararlar alýn.',
...
const plans = [
  {
    ...
    badge: 'Baþlangýç',
    features: ['Ana sayfa listeleme', 'Kategori sayfasýnda öne çýkarma', '10.000 aylýk gösterim', 'Temel raporlama', 'E-posta desteði'],
  },
  {
    name: 'Standart', price: '4.999', originalPrice: '6.999',
    badge: 'Popüler', popular: true,
    features: ['Ana sayfa listeleme', 'Kategori sayfasýnda öne çýkarma', '50.000 aylýk gösterim', 'Geliþmiþ raporlama', 'Öncelikli destek', 'A/B test imkaný'],
  },
  {
    name: 'Premium', price: '9.999', originalPrice: '14.999',
    badge: 'Profesyonel',
    features: ['Ana sayfa listeleme', 'Kategori sayfasýnda öne çýkarma', 'Sýnýrsýz gösterim', 'Özel raporlama & Danýþmanlýk', 'Öncelikli 7/24 destek', 'Adwords & Meta entegrasyonu'],
  },
]

const steps = [
  { num: '1', title: 'Hedef Belirle', desc: 'Kitle, bölge ve bütçenizi seçin.' },
  { num: '2', title: 'Reklam Oluþtur', desc: 'Görsel, baþlýk ve açýklamanýzý ekleyin.' },
  { num: '3', title: 'Yayýna Al', desc: 'Kampanyanýz anýnda baþlasýn.' },
  { num: '4', title: 'Ýzle & Optimize', desc: 'Performansý takip edin, iyileþtirin.' },
]

const testimonials = [
  { name: 'Ayþe Yýlmaz', business: 'Bella Kuaför', city: 'Ýstanbul', text: 'Reklam kampanyasýna baþladýktan sonra müþteri sayýmýz %70 arttý. Kesinlikle tavsiye ediyorum.', rating: 5 },
  { name: 'Mehmet Demir', business: 'Osmangazi Spor Salonu', city: 'Bursa', text: 'Rakip analizi ve hedefleme özellikleri sayesinde bütçemizi çok verimli kullanýyoruz.', rating: 5 },
  { name: 'Zeynep Kaya', business: 'Lavanta Terapi', city: 'Ýzmir', text: 'Aylýk 5.000 TL\'lik bütçeyle 40.000\'den fazla potansiyel müþteriye ulaþtýk.', rating: 5 },
]

const faq = [
  { q: 'Reklam kampanyasý ne zaman baþlar?', a: 'Kampanyanýz ödeme onaylandýktan sonra en geç 24 saat içinde yayýna girer.' },
  { q: 'Bütçemi sonradan deðiþtirebilir miyim?', a: 'Evet, dilediðiniz zaman kampanya bütçenizi artýrabilir veya azaltabilirsiniz.' },
  { q: 'Hangi ödeme yöntemlerini kabul ediyorsunuz?', a: 'Kredi kartý, banka kartý ve EFT/havale ile ödeme yapabilirsiniz.' },
  { q: 'Reklam performansýmý nasýl takip ederim?', a: 'Panelinizden anlýk gösterim, týklanma ve dönüþüm verilerinizi görüntüleyebilirsiniz.' },
]
    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-28 text-white">
          ...
          <div className="relative mx-auto max-w-5xl px-4 text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-6">
              Ýþletmenizi<br />
              <span className="bg-gradient-to-r from-brand-500 to-yellow-400 bg-clip-text text-transparent">büyütmeye</span> hazýr mýsýnýz?
            </h1>
            <p className="mx-auto max-w-2xl text-lg text-gray-300 mb-10">
              JetRandevu reklam aðý ile iþletmenizi hedef kitlenize ulaþtýrýn, müþteri sayýnýzý katlayýn. 
              Üstelik sadece sonuç alacaðýnýz reklam modeliyle.
            </p>
        ...
        <section className="py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              ...
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Ýþletmenize Deðer Katan Çözümler</h2>
              <p className="mx-auto max-w-2xl text-gray-500">Veri odaklý reklam çözümlerimizle doðru kitleye, doðru zamanda, doðru mesajla ulaþýn.</p>
            </div>
        ...
        <section className="bg-gradient-to-b from-gray-50 to-white py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Nasýl Çalýþýr?</p>
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">4 Adýmda Reklam Yayýnlayýn</h2>
              <p className="mx-auto max-w-2xl text-gray-500">Karmaþýk süreçlere son. Birkaç týklamayla reklam kampanyanýzý baþlatýn.</p>
            </div>
        ...
        <section id="packages" className="py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-gray-500">Tüm paketlerde 14 gün para iade garantisi. Ýstediðiniz zaman yükseltebilirsiniz.</p>
            </div>
        ...
        <section className="bg-gray-900 py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Müþteri Yorumlarý</p>
              <h2 className="text-4xl font-extrabold text-white mb-4">Reklamverenler Ne Diyor?</h2>
              <p className="mx-auto max-w-2xl text-gray-400">Binlerce iþletme JetRandevu ile büyüyor. Onlarýn baþarý hikayelerini keþfedin.</p>
            </div>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-24">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Reklamveren Olmaya Hazýr Mýsýnýz?</h2>
            <p className="text-gray-300 text-lg mb-8">Ýlk kampanyanýzý oluþturun, iþletmenizi binlerce potansiyel müþteriye tanýtýn.</p>
            <div className="flex items-center justify-center gap-4">
              <Link href="/register"
