      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-28 text-white">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            ...
            <h1 className="text-5xl font-extrabold leading-tight mb-4">JetRandevu&apos;i Keþfedin</h1>
            <p className="mx-auto max-w-xl text-lg text-gray-300 mb-8">Canlý bir demo talep edin, ekibimiz size özel bir tur düzenlesin.</p>
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link href="/register" className="flex items-center gap-2 rounded-xl bg-brand-500 px-6 py-3.5 text-base font-bold text-white hover:bg-brand-600 transition-all shadow-lg shadow-brand-500/25">
                <Play className="h-4 w-4" /> Hemen Baþla
              </Link>
        ...
        <section className="bg-white py-24">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 sm:grid-cols-3">
              {[
                { icon: CalendarCheck, title: 'Online Randevu', desc: 'Müþterileriniz 7/24 rezervasyon yapabilir.' },
                { icon: Users, title: 'Müþteri Yönetimi', desc: 'Tüm müþteri verileriniz tek panelde.' },
                { icon: BarChart3, title: 'Raporlama', desc: 'Gerçek zamanlý gelir ve performans analitiði.' },
              ].map((item) => (
