...
export const metadata = { title: 'Sponsorlu Öne Çýkan — JetRandevu' }

const stats = [
  { value: '%320', label: 'Ortalama Týklanma Artýþý' },
  { value: '2.5x', label: 'Daha Fazla Müþteri' },
  { value: '15K+', label: 'Sponsorlu Ýþletme' },
  { value: '81', label: 'Þehirde Aktif' },
]

const benefits = [
  {
    icon: Star, title: 'Ön Sýralarda Yer Alýn', desc: 'Kategorinizde ve aramalarda sponsorlu olarak en üst sýralarda görünün.',
    gradient: 'from-amber-500 to-orange-500',
  },
  {
    icon: TrendingUp, title: 'Týklanma Oranýnýzý Artýrýn', desc: 'Sponsorlu etiketiyle organik sonuçlardan sýyrýlýn, rakiplerinizin önüne geçin.',
    gradient: 'from-blue-500 to-cyan-500',
  },
  {
    icon: Search, title: 'Doðru Kitleye Ulaþýn', desc: 'Sadece sizin sektörünüzde ve bölgenizde arama yapan kullanýcýlara öne çýkýn.',
    gradient: 'from-emerald-500 to-green-500',
  },
  {
    icon: Zap, title: 'Anýnda Yayýna Girin', desc: 'Sponsorlu öne çýkma kampanyanýz ödeme sonrasý dakikalar içinde aktif olur.',
...
const plans = [
  {
    name: 'Gümüþ', price: '799', originalPrice: '1.199',
    badge: 'Ekonomik',
    features: ['Kategori sayfasýnda öne çýkma', 'Sponsorlu etiketi', '5.000 aylýk gösterim', 'Temel istatistikler', 'E-posta desteði'],
  },
  {
    name: 'Altýn', price: '1.999', originalPrice: '2.999',
    badge: 'En Popüler', popular: true,
    features: ['Kategori sayfasýnda öne çýkma', 'Sponsorlu etiketi', '20.000 aylýk gösterim', 'Geliþmiþ istatistikler', 'Ana sayfada listeleme', 'Öncelikli destek'],
  },
  {
    name: 'Platin', price: '4.999', originalPrice: '7.499',
    badge: 'Premium',
    features: ['Kategori sayfasýnda öne çýkma', 'Sponsorlu etiketi', 'Sýnýrsýz gösterim', 'Özel raporlama', 'Ana sayfada listeleme', '7/24 öncelikli destek', 'SEO danýþmanlýðý'],
  },
]

const showcase = [
  { name: 'Bella Kuaför', city: 'Ýstanbul', rating: 4.8, category: 'Güzellik', color: 'from-pink-500 to-rose-500' },
  { name: 'Diþ Hekimi Murat Yýlmaz', city: 'Ankara', rating: 4.9, category: 'Saðlýk', color: 'from-blue-500 to-cyan-500' },
  { name: 'Osmangazi Spor Salonu', city: 'Bursa', rating: 4.7, category: 'Fitness', color: 'from-emerald-500 to-green-500' },
  { name: 'Lavanta Terapi', city: 'Ýzmir', rating: 4.9, category: 'Masaj & Spa', color: 'from-violet-500 to-purple-500' },
]

const testimonials = [
  { name: 'Can Öztürk', business: 'Diþ Hekimi Murat Yýlmaz', city: 'Ankara', text: 'Sponsorlu öne çýkan olduktan sonra randevu taleplerimiz %150 arttý. Harika bir sistem.', rating: 5 },
  { name: 'Selin Aydýn', business: 'Bella Kuaför', city: 'Ýstanbul', text: 'Rakiplerimin önüne geçmek için mükemmel bir fýrsat. Aylýk müþteri sayým ikiye katlandý.', rating: 5 },
]

const faq = [
  { q: 'Sponsorlu öne çýkan nedir?', a: 'Ýþletmenizin belirli anahtar kelime ve kategorilerde, normal sonuçlarýn üzerinde öne çýkarýlmasýdýr.' },
  { q: 'Ne kadar sürede aktif olur?', a: 'Ödeme sonrasý ortalama 15 dakika içinde sponsorlu öne çýkan listenizde yer almaya baþlarsýnýz.' },
  { q: 'Faturalandýrma nasýl yapýlýr?', a: 'Aylýk olarak faturalandýrýlýr. Ýstediðiniz zaman iptal edebilir, bir sonraki dönem yenilenmez.' },
  { q: 'Performansýmý görebilir miyim?', a: 'Evet, panelinizden gösterim, týklanma ve müþteri dönüþüm verilerinizi anlýk takip edebilirsiniz.' },
]
    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-28 text-white">
          ...
          <div className="relative mx-auto max-w-5xl px-4 text-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-4 py-1.5 text-xs font-medium text-brand-500 mb-6">
              <Sparkles className="h-3 w-3" /> Öne Çýkmanýn En Akýllý Yolu
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-6">
              Ýþletmenizi öne çýkarýn,<br />
              <span className="bg-gradient-to-r from-brand-500 to-yellow-400 bg-clip-text text-transparent">rakiplerinizi</span> geride býrakýn
            </h1>
            <p className="mx-auto max-w-2xl text-lg text-gray-300 mb-10">
              Sponsorlu öne çýkan olarak iþletmenizi binlerce kullanýcýnýn karþýsýna çýkarýn, 
              sektörünüzde fark edilin ve müþteri sayýnýzý katlayýn.
            </p>
            <div className="flex items-center justify-center gap-4">
              <Link href="/register"
                ...
                Hemen Baþla <ArrowRight className="h-4 w-4 group-hover:translate-x-0.5 transition-transform" />
              </Link>
              <Link href="#packages"
        ...
        <section className="py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Öne Çýkan Ýþletmeler</p>
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Sponsorlu Ýþletmeler Daha Çok Tercih Ediliyor</h2>
              <p className="mx-auto max-w-2xl text-gray-500">Türkiye&apos;nin dört bir yanýndan binlerce iþletme sponsorlu öne çýkan olarak büyüyor.</p>
            </div>
        ...
        <section className="bg-gradient-to-b from-gray-50 to-white py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              ...
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Sponsorlu Öne Çýkmanýn Gücü</h2>
              <p className="mx-auto max-w-2xl text-gray-500">Rakiplerinizin bir adým önünde olmak için ihtiyacýnýz olan her þey.</p>
            </div>
        ...
        <section id="packages" className="py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Fiyatlandýrma</p>
              <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Size Uygun Paketi Seçin</h2>
              <p className="mx-auto max-w-2xl text-gray-500">Her bütçeye uygun paketler. 14 gün içinde memnun kalmazsanýz paranýz iade.</p>
            </div>
              ...
              {plans.map((p) => (
                <div key={p.name} className={`relative rounded-3xl border-2 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl ${p.popular ? 'border-brand-500 shadow-xl shadow-brand-500/10 scale-105 md:scale-110' : 'border-gray-100 hover:border-gray-200'}`}>
                  ...
                  <CheckoutLink type="sponsored" plan={p.name}
                    ...
                    {p.popular ? 'Hemen Baþla' : 'Paketi Seç'}
                  </CheckoutLink>
                </div>
              ))}
            </div>
        ...
        <section className="bg-gray-900 py-28">
          <div className="mx-auto max-w-screen-2xl px-4">
            <div className="mb-16 text-center">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Baþarý Hikayeleri</p>
              <h2 className="text-4xl font-extrabold text-white mb-4">Sponsorlu Ýþletmeler Ne Diyor?</h2>
              <p className="mx-auto max-w-2xl text-gray-400">Sponsorlu öne çýkan ile büyüyen iþletmelerin baþarý hikayeleri.</p>
            </div>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-24">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Öne Çýkmaya Hazýr Mýsýnýz?</h2>
            <p className="text-gray-300 text-lg mb-8">Hemen kaydolun, iþletmenizi sponsorlu öne çýkan yaparak rakiplerinizin önüne geçin.</p>
            <Link href="/register"
              ...
              Ücretsiz Hesap Oluþtur <ArrowRight className="h-4 w-4 group-hover:translate-x-0.5 transition-transform" />
            </Link>
          </div>
        </section>
      </main>
