      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-24">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            ...
            <Link href="/register"
              className="group inline-flex items-center gap-2 rounded-xl bg-brand-500 px-10 py-4 text-base font-bold text-black hover:bg-brand-600 transition-all shadow-lg shadow-brand-500/25">
