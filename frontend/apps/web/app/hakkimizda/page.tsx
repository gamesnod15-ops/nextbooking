...
export const metadata = { title: 'Hakkýmýzda — JetRandevu' }

const milestones = [
  {
    year: '2023',
    title: 'Kuruluþ',
    desc: 'Ýstanbul\'da 5 kiþilik bir ekiple kurulduk. Basit bir soruna çözüm arýyorduk.',
    icon: '??',
  },
  {
    year: '2024',
    title: 'Ýlk 1.000 Müþteri',
    desc: '6 ayda 1.000 aktif iþletmeye ulaþtýk. Güven inþa ettik.',
    icon: '??',
  },
  {
    year: '2024',
    title: 'Seri A Yatýrým',
    desc: 'Ekibimizi 30 kiþiye geniþlettik. Teknoloji altyapýmýzý güçlendirdik.',
    icon: '??',
  },
  {
    year: '2025',
    title: '10.000+ Ýþletme',
    desc: 'Türkiye genelinde 10.000+ iþletme bize güvendi. Büyümeye devam ediyoruz.',
    icon: '??',
  },
]
...
const values = [
  {
    title: 'Müþteri Odaklýlýk',
    desc: 'Her kararýmýzda müþterilerimizin baþarýsýný ön planda tutuyoruz.',
    icon: '??',
    color: 'from-blue-500 to-blue-600',
  },
  {
    title: 'Hýz & Basitlik',
    desc: 'Karmaþýk yazýlýmlar yerine 5 dakikada kullanýlabilir bir platform.',
    icon: '?',
    color: 'from-amber-500 to-orange-600',
  },
  {
    title: 'Güvenilirlik',
    desc: '%99.9 uptime garantisi ve PCI DSS uyumlu altyapý.',
    icon: '???',
    color: 'from-emerald-500 to-emerald-600',
  },
  {
    title: 'Empati',
    desc: 'Ýþletme sahiplerinin günlük zorluklarýný anlýyoruz.',
    icon: '??',
...
const team = [
  {
    ...
    quote: 'Teknoloji her iþletmenin eriþebileceði kadar basit olmalý.',
  },
  {
    name: 'Selin Kaya',
    role: 'CTO',
    img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80',
    quote: 'Mükemmel ürün, kullanýcýyý düþünerek baþlar.',
  },
  {
    name: 'Emre Doðan',
    role: 'Ürün Direktörü',
    img: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=80',
    quote: 'Her detay, kullanýcý deneyimini etkiler.',
  },
  {
    name: 'Ayþe Tekin',
    role: 'Müþteri Deneyimi',
    img: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&q=80',
    quote: 'Müþterilerimizin sesi her zaman önceliðimiz.',
  },
  {
    name: 'Can Demir',
    role: 'Baþ Geliþtirici',
    img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
    quote: 'Temiz kod, hýzlý product demektir.',
  },
]
      ...
      <main>
            ...
            <div className="grid gap-16 lg:grid-cols-2 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Kurucumuz Mert, kardeþinin güzellik salonunu ziyaret ettiðinde telefon trafiðinin yarattýðý kaosu gördü.
                    Müþteriler randevu almak için saat bekliyordu.
                  </p>
                  <p>
                    &ldquo;Bu sorunu çözmek için birkaç hafta yeter&rdquo; diye düþünerek baþladýðý yolculuk, bugün
                    10.000&apos;den fazla iþletmenin güvendiði bir platforma dönüþtü.
                  </p>
                  <p>
                    Ekibimiz SaaS, ödeme sistemleri ve kullanýcý deneyimi alanlarýnda deneyimli geliþtiriciler,
                    tasarýmcýlar ve iþletme uzmanlarýndan oluþuyor.
                  </p>
                </div>
              </div>
        ...
        <section className="bg-white py-24 overflow-hidden">
          <div className="mx-auto max-w-6xl px-5">
            <div className="text-center mb-16">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-400 mb-3">Yolculuðumuz</p>
        ...
        <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-24 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-5">
            <div className="text-center mb-14">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand-500 mb-3">Deðerlerimiz</p>
        ...
        <section className="bg-white py-24">
          <div className="mx-auto max-w-6xl px-5">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Arkamýzdaki insanlar</h2>
              <p className="mt-3 text-gray-500">Tutkulu ekibimizden bazý isimler</p>
            </div>
        ...
        <section className="bg-[#1a1a1a] py-20 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
            Bizimle Büyümek Ýster misiniz?
          </h2>
          <p className="text-gray-400 max-w-xl mx-auto mb-8">
            14 gün ücretsiz deneme ile JetRandevu&apos;ý keþfedin.
          </p>
          <Link
            href="/register"
