...
export const metadata = { title: 'Blog — JetRandevu', description: 'Randevu sistemi, iþletme yönetimi ve dijitalleþme hakkýnda blog yazýlarý.' }

const posts = [
  { title: 'Online Randevu Sistemi ile Müþteri Memnuniyetini Artýrýn', date: '15 Mayýs 2026', slug: 'online-randevu-musteri-memnuniyeti' },
  { title: 'Kuaförünüz Ýçin Dijital Pazarlama Stratejileri', date: '8 Mayýs 2026', slug: 'kuafor-dijital-pazarlama' },
  { title: 'Ýþletmenizde Verimliliði Artýracak 5 Araç', date: '1 Mayýs 2026', slug: 'verimlilik-araclari' },
  { title: 'Müþteri Sadakat Programý Nasýl Oluþturulur?', date: '24 Nisan 2026', slug: 'musteri-sadakat-programi' },
      ...
      <main>
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-24 text-white">
          ...
          <div className="relative mx-auto max-w-3xl px-4 text-center">
            ...
            <h1 className="text-5xl font-extrabold leading-tight mb-4">Ýþletmenizi Büyütecek Ýpuçlarý</h1>
            <p className="mx-auto max-w-xl text-lg text-gray-300">Randevu sistemi, dijitalleþme ve iþletme yönetimi hakkýnda en güncel yazýlar.</p>
          </div>
        </section>
