      ...
      <div className="max-w-md w-full rounded-2xl border bg-white p-10 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-500 px-4 py-3 text-sm font-bold text-white hover:bg-brand-600 transition-colors disabled:opacity-50"
          >
