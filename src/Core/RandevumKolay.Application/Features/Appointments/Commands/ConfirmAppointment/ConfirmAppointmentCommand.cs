...
namespace RandevumKolay.Application.Features.Appointments.Commands.ConfirmAppointment;

public record ConfirmAppointmentCommand(Guid Id) : IRequest;

public sealed class ConfirmAppointmentCommandHandler : IRequestHandler<ConfirmAppointmentCommand>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentTenantService _tenantService;

    public ConfirmAppointmentCommandHandler(IApplicationDbContext context, ICurrentTenantService tenantService)
    {
        _context = context;
